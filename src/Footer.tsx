        ...
        <div>
            ...
            <footer className="bg-white dark:bg-gray-900">
                <div className="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
                    <div>
                        <h2 className="mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">Resorts</h2>
                        <ul className="text-gray-500 dark:text-gray-400">
                            <li className="mb-4">
                                <a href="#" className=" hover:underline">Explore</a>
                            </li>
                            <li className="mb-4">
                                <a href="#" className="hover:underline">Viagens</a>
                            </li>
                            <li className="mb-4">
                    ...
                    <div>
                        <h2 className="mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">Contato</h2>
                        <ul className="text-gray-500 dark:text-gray-400">
                            <li className="mb-4">
                            ...
                            <li className="mb-4">
                                <a href="#" className="hover:underline">Telefone</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        <h2 className="mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">Informações</h2>
                        <ul className="text-gray-500 dark:text-gray-400">
                            <li className="mb-4">
                ...
                <div className="py-6 px-4 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
                    <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2022 <a href="">TavimFernandes™</a>. Todos os direitos reservados.
                    </span>
                    <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
                        <a href="#" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
                            ...
                            <span className="sr-only">Página Facebook</span>
                        </a>
                        <a href="#" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
